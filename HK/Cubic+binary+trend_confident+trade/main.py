...
def load_features_data(file_path='d:/BaiduNetdiskDownload/mamba (2)/mamba/hk_16_indicators.npz'):
...
def main():
    ...
    HSI_returns = df['HSI_returns'].tolist()
    X, dates = load_features_data()
    print("X shape:", X.shape)

    Y = np.array(HSI_returns[WINDOW_SIZE:])
    Y[-1] = 0
