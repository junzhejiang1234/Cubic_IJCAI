...
def process_stock_data(stocks_data):
    ...
    features_to_standardize = [
        'Close', 'MA20', 'RSI', 'MACD', 'Volatility',
        'Momentum', 'Volume_Change', 'VWAP', 'Volume'
    ]
...
def backtest_result(test_predictions, test_actuals):
    ...
    print(f"Annualized Return (AR): {ar*100:.2f}%")
    print(f"Market Annualized Return: {market_ar*100:.2f}%")
    ...
    print(f"Directional Prediction Accuracy: {direction_accuracy*100:.2f}%")
