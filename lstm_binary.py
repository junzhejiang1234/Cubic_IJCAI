...
if __name__ == "__main__":
    try:
        ...
        print(f"IC: {ic_mean:.4f}, {ic_std:.4f}")
        print(f"ICIR: {icir_mean:.4f}, {icir_std:.4f}")
        print(f"Direction Accuracy: {direction_accuracy_mean:.4f}, {direction_accuracy_std:.4f}")
        print(f"Sharpe Ratio: {sharpe_ratio_mean:.4f},  {sharpe_ratio_std:.4f}")
        print(f"AR: {ar_mean:.4f},  {ar_std:.4f}")    
